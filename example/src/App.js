...
const App = () => {
  return (
    <Tabs
      ...
      <TabPane tab="Panel Sandbox" key="7"><PanelSandbox /></TabPane>
      <TabPane tab="RangeDtPicker Sandbox" key="8"><RangeDtPickerSandbox /></TabPane>
      <TabPane tab="StatusFilter Sandbox" key="9"><StatusFilterSandbox /></TabPane>
      <TabPane tab="SemiCircularBar Sandbox" key="10"><SemiCircularBarSandbox /></TabPane>
      <TabPane tab="SearchBar Sandbox" key="11"><SearchBarSandbox /></TabPane>
      <TabPane tab="TextInput Sandbox" key="12"><TextInputSandbox /></TabPane>
      <TabPane tab="UniTable Sandbox" key="13"><UniTableSandbox /></TabPane>
      <TabPane tab="UniTableSearch Sandbox" key="14"><UniTableSearchSandbox /></TabPane>
      <TabPane tab="Wait4Me Sandbox" key="15"><Wait4MeSandbox /></TabPane>
